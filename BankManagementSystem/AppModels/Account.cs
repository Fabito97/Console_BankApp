        ...
        public virtual void Transfer(Account sourceAccount, Account targetAccount, decimal amount)
        {
            ...
            if (sourceAccount.Withdraw(sourceAccount, amount))
            {
                if (targetAccount.Deposit(targetAccount, amount))
                {
                    ...
                    var transfer = new Transaction(sourceAccount.AccountNumber, DateTime.Now, amount, TransactionType.Transfer, sourceAccount.Balance);
                    var credit = new Transaction(targetAccount.AccountNumber, DateTime.Now, amount, TransactionType.Transfer, targetAccount.Balance);
